	...
	if ( ! empty( $shop_isle_homepage_slider_shortcode ) ) {
		...
		if ( ! empty( $shop_isle_big_title_image ) ) {
			...
			if ( ! empty( $shop_isle_big_title_title ) ) {
				echo '<h1 class="hs-title-size-4 font-alt mb-30"><img style="padding-left:15px; padding-right:15px;padding-top:40px;" src="'.get_template_directory_uri().'/assets/images/happyGreen_2.png"/></h1>';
